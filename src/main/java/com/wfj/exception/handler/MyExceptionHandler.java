package com.wfj.exception.handler;

import com.wfj.exception.common.ErrStatusEnum;
import com.wfj.exception.common.ErrorLevel;
...
import com.wfj.exception.sync.ClientSendSync;
...
public class MyExceptionHandler extends Throwable {
	...
	public MyExceptionHandler(String busiCode, String errCode, Throwable e) {
		try {
			new ClientSendSync().clientSendMsg(createExceptionPro(busiCode, errCode, e, ErrorLevel.ERROR.getCode()));
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
	...
	public MyExceptionHandler(String busiCode, String busiDesc, String errCode, String errDesc, Throwable e) {
		try {
			new ClientSendSync().clientSendMsg(createExceptionPro(busiCode, busiDesc, errCode, errDesc, e, ErrorLevel.ERROR.getCode()));
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
	...
	public void putException(String busiCode, String errCode, Throwable e) {
		try {
			new ClientSendSync().clientSendMsg(createExceptionPro(busiCode, errCode, e, ErrorLevel.WARING.getCode()));
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
	...
	public void putException(String busiCode, String busiDesc, String errCode, String errDesc, Throwable e) {
		try {
			new ClientSendSync().clientSendMsg(createExceptionPro(busiCode, busiDesc, errCode, errDesc, e, ErrorLevel.WARING.getCode()));
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
	...
	private static ClientExceptionReq getExceptionObj(Throwable e) {
		...
		req.setSysCode(PropertiesLoad.getProperties("sysCode"));
